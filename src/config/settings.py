"""Application configuration for Enterprise Knowledge Agent."""
...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/enterprise_knowledge_agent",
    ...
    opensearch_index: str = Field(default="enterprise_knowledge_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="enterprise-knowledge-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="enterprise-knowledge-agent", description="A2A agent ID")
