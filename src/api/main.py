"""Enterprise Knowledge Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Enterprise knowledge management agent that indexes organizational knowledge, answers questions from internal sources, maintains institutional memory, identifies knowledge gaps, and facilitates knowledge sharing.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
