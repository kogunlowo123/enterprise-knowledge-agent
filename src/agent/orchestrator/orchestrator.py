"""Enterprise Knowledge Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Enterprise Knowledge Agent through a multi-step pipeline.
